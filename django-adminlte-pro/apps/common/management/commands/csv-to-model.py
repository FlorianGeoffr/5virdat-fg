...
OUTPUT_GEN_MODELS = os.path.join('apps' , 'common', 'models.py' )
OUTPUT_GEN_FORMS  = os.path.join('apps' , 'common', 'forms.py'  )
    ...
    def handle(self, *args, **kwargs):
        ...
        if input_file:
            ...
            if 'http' in input_file:
                ...
                remote_model_name   = remote_model_name_v.title() + '.csv'
        ...
        MODEL_FILE_c    = file_load( OUTPUT_GEN_MODELS, MODEL_FILE_MARK )
        FORM_FILE_c     = file_load( OUTPUT_GEN_FORMS, MODEL_FILE_MARK )
        ...
        if simulation:
            ...
            for file_name in csv_files:
                ...
                # Model extraction case     
                    ...
                    print(f" *** GENERATE Form")

                    # Update FORMS with generated Code
                    FORM_FILE_c += generate_form( model_name, model_data, mapper )

                    if file_save( OUTPUT_GEN_FORMS, FORM_FILE_c ):
                        print(f"   -> File saved")
                    else:
                        print(f"   -> ERR saving OUTPUT file: " + FORM_FILE_c)                        
